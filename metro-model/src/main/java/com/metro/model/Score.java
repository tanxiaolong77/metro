...
public class Score {
    ...
    public void setTheoryScore(String theoryScore) {
        this.theoryScore = theoryScore == null ? null : theoryScore.trim();
    }
    ...
    public void setOperateScore(String operateScore) {
        this.operateScore = operateScore == null ? null : operateScore.trim();
    }
    ...
    public void setAddupScore(String addupScore) {
        this.addupScore = addupScore == null ? null : addupScore.trim();
    }
